...
import { RoomsPut } from "./../../../../redux/rooms/index";
import { useDispatch } from "react-redux";
import { OrdersDelete, OrdersPut } from "../../../../redux/orders";
...
import ModalInput from "../modal-print";
...
const RoomTab = ({ dataFind, id }) => {
  ...
  dispatch(
    ...
    await axios
    .put(
      `https://crm.supersiteuz.com/orders/${id}`,
      bodyrooms2
    )
    .then((res) => res);
    await axios
      .put(
        `https://crm.supersiteuz.com/rooms/${dataFind.map(
          (elem) => elem.rooms?.id
        )}`,
        bodyrooms
      )
